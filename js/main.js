...
const groupsRenderer = {
        ...
        return `
            <div class="group-card ${group.isVIP ? 'vip' : ''}">
                ...
                <div class="group-card-content">
                    ...
                    <span class="group-card-category">${group.categories.name}</span>
                    ...
                    <div class="group-card-footer">
                        ...
                        <a href="grupo.html?id=${group.id}" class="btn btn-primary btn-sm">Ver detalhes</a>
                    </div>
                </div>
            </div>
        `;
    ...
    async renderGroupsList(containerId, filters = {}) {
        ...
        try {
            ...
            if (groups.length === 0) {
                container.innerHTML = '<p class="text-center">Nenhum grupo encontrado. <a href="cadastrar.html">Seja o primeiro a cadastrar!</a></p>';
                return;
            }
    ...
    // Renderizar detalhes de um grupo
    async renderGroupDetails(groupId) {
        ...
        try {
            ...
            container.innerHTML = `
                <div class="group-details-container">
                    <div class="group-header">
                        ...
                        <div class="group-info">
                            ...
                            <div class="group-meta">
                                <span class="group-category">Categoria: ${group.categories.name}</span>
                    ...
                    <div class="group-action">
                        <a href="${group.invite_link}" target="_blank" class="btn btn-${group.platform}">Entrar no Grupo</a>
                    </div>
                </div>
            `;
            ...
            if (metaDescription) {
                metaDescription.content = group.description;
            }
        } catch (error) {
...
const forms = {
    // Inicializar formulário de cadastro de grupo
    async initGroupForm() {
        ...
        form.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    // Redirecionar para a página anterior ou para o início
